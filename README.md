...
**🍇 Updates**
- **`2023/12/10`** Support [Grounded-Efficient-SAM](https://github.com/IDEA-Research/Grounded-Segment-Anything/tree/add_efficient_sam/EfficientSAM#run-grounded-efficient-sam-demo) demo, thanks a lot for their great work!
...
- [Grounded-SAM Playground](#grounded-sam-playground)
  ...
  - [Efficient SAM Series for faster labelling](./EfficientSAM/)
    ...
    - [Grounded-Efficient-SAM Demo](https://github.com/IDEA-Research/Grounded-Segment-Anything/tree/add_efficient_sam/EfficientSAM#run-grounded-efficient-sam-demo)
