...
**🍇 Updates**
- **`2023/06/20`** By combining **Grounding-DINO-L** with **SAM-ViT-H**, Grounded-SAM has won **the first place** on [Segmentation in the Wild](https://eval.ai/web/challenges/challenge-page/1931/overview) [CVPR 2023 workshop](https://computer-vision-in-the-wild.github.io/cvpr-2023/) competition zero-shot track, surpassing the second place about **4 mAP**.
